...
describe('Create Object with Organization Identity API', function () {
    ...
    it('POST /api/config/organization-identity sets the organization identity', function (done) {
        const body = {
    ...
    it('POST /api/tactics creates a new version of the tactic', function (done) {
